...
namespace TinyReflectiveToolkit.Contracts
{
    ...
    /// application of the modulus operator on the provided object and another object.
    /// </summary>
    [AttributeUsage(AttributeTargets.Method, Inherited = false, AllowMultiple = false)]
    public sealed class ModulusAttribute : ExposeBinaryOperatorAttribute
    {
        /// <summary>
