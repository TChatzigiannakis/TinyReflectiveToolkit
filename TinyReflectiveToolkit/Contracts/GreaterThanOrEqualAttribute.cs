...
namespace TinyReflectiveToolkit.Contracts
{
    ...
    /// application of the greater-than-or-equal operator on the provided object and another object.
    /// </summary>
    [AttributeUsage(AttributeTargets.Method, Inherited = false, AllowMultiple = false)]
    public sealed class GreaterThanOrEqualAttribute : ExposeBinaryOperatorAttribute
    {
        /// <summary>
